   ...
   <main style="padding-top:10px;">
        <div class="row main-container">
            <div class="col-12 d-flex justify-content-center mb-2">
                <h2 class="text-center text-primary">Dc Current Graph</h2>
            </div>
            <div class="div-ddl">
                ...
                <div class="dropdown-container">
                    ...
                    <select id="device-select" v-model="selectedDeviceId" @change="fetchgraphdata" class="custom-select"
                        ...
                        <option v-for="device in deviceList.filter(device => device.deviceType === 'Dc Current')"
        ...
        async fetchgraphdata() {
            try {
                ...
                channelData.forEach((channel) => {
                    ...
                    const channelName = `${channel.channalId} - ${gearType}`;
                    const channelSeries = {
                        name: channelName,
